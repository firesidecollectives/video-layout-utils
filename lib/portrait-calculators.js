...
exports.portraitCalculators = {
    ...
    pppl: function (_a) {
        ...
        var _d = (0, utils_1.findLargestPortraitBox)({
            height: containerHeight - middlePortraitHeight - landscapeHeight,
            width: containerWidth,
        }), topPortraitHeight = _d.height, topPortraitWidth = _d.width;
        var top = (0, utils_1.getCenterOffset)(containerHeight, topPortraitHeight + middlePortraitHeight + landscapeHeight);
        return [
            {
                height: topPortraitHeight,
                width: topPortraitWidth,
                left: (0, utils_1.getCenterOffset)(containerWidth, topPortraitWidth),
                top: top,
                nameTop: insets.top,
            },
            {
                ...
                left: (0, utils_1.getCenterOffset)(containerWidth, middlePortraitWidth * 2),
                top: top + topPortraitHeight,
            },
            {
                height: middlePortraitHeight,
                width: middlePortraitWidth,
                left: middlePortraitWidth +
                    (0, utils_1.getCenterOffset)(containerWidth, middlePortraitWidth * 2),
                top: top + topPortraitHeight,
            },
            {
                height: landscapeHeight,
                width: landscapeWidth,
                top: top + topPortraitHeight + middlePortraitHeight,
                left: (0, utils_1.getCenterOffset)(containerWidth, landscapeWidth),
            },
        ];
    },
    pplp: function (_a) {
        ...
        var _c = (0, utils_1.findLargestPortraitBox)({
            height: Math.min(containerHeight / 3, (containerHeight - landscapeHeight) / 2),
            width: containerWidth,
        }), bottomPortraitHeight = _c.height, bottomPortraitWidth = _c.width;
        var _d = (0, utils_1.findLargestPortraitBox)({
            height: containerHeight - landscapeHeight - bottomPortraitHeight,
            width: containerWidth / 2,
        }), topPortraitHeight = _d.height, topPortraitWidth = _d.width;
        var top = (0, utils_1.getCenterOffset)(containerHeight, landscapeHeight + bottomPortraitHeight + topPortraitHeight);
        return [
            {
                height: topPortraitHeight,
                width: topPortraitWidth,
                left: (0, utils_1.getCenterOffset)(containerWidth, topPortraitWidth * 2),
                top: top,
                nameTop: insets.top,
            },
            {
    ...
    plpp: function (_a) {
        ...
        var _d = (0, utils_1.findLargestPortraitBox)({
            height: containerHeight - bottomPortraitHeight - landscapeHeight,
            width: containerWidth,
        }), topPortraitHeight = _d.height, topPortraitWidth = _d.width;
        var top = (0, utils_1.getCenterOffset)(containerHeight, topPortraitHeight + bottomPortraitHeight + landscapeHeight);
        return [
            {
                height: topPortraitHeight,
                width: topPortraitWidth,
            ...
            },
            {
                height: bottomPortraitHeight,
                width: bottomPortraitWidth,
                left: (0, utils_1.getCenterOffset)(containerWidth, bottomPortraitWidth * 2),
                top: top + topPortraitHeight + landscapeHeight,
            },
            {
                height: bottomPortraitHeight,
